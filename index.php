                  ...
                  <nav class="navbar navbar-expand-lg header-navbar ml-0 ml-lg-5">
                     ...
                     <div class="nav-menu collapse navbar-collapse navbar-collapse justify-content-end mr-5 ">
                        <ul class=" navbar-nav  header-navbar-nav">
                           ...
                           <li><a class=" nav-link scroll" href="#penutup">Penutup</a></li>
                        </ul>
                     </div>
                  </nav>
               </div>
                  ...
                  <div class="col-md-6">
                     <div class="svg-mask-container">
                        <svg version="1.1" id="p.svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 980.2914 884.5557" enable-background="new 0 0 980.2914 884.5557" xml:space="preserve">
                           ...
                           <image mask="url(#mask)" width="981" height="885" class="" xlink:href="assets/img/foto-siluet.jpg" />
                           <g>
...
<g>
   <path d="M0,0c0,0,219.6543,165.951,730.788,124.0771c383.3156-31.4028,827.2139-96.9514,1244.7139-96.9514
      c212.5106,0,438.9999,3.5,584.4982,1.5844v139.9126H0V0z"/>
               ...
               <div class="row justify-content-center">
                  <div class="col">
                     <div class=" text-center mb-5 pb-5">
                        ...
                        <p class="w-md-40 mb-2 mx-auto text-dark-gray opacity-8 ">
                           Bapak H. Abdul Rozak & Ibu Hj. Neneng Komariah<br>
                           Bersama dengan<br>
                           Bapak Rudi Hermawan (alm) & Ibu Marwanih<br>
                           Memohon doa restu untuk menikahkan putra dan putri kami:<br>
                        </p>
                        <h1 class="font-sambung mb-4">Sandyta Nurwarohmah Firmansyah <span class="text-primary">(Dita)</span><br>&<br>Muhammad Alhindi <span class="text-primary">(Hindi)</span></h1>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <section id="pelaksanaan" class="spacer-one-top-lg">
            <!--Container-->
            <div class="container spacer-one-bottom-lg">
               <!--Row-->
               <div class="row justify-content-center">
                  ...
                  <div class="col-md-7 d-flex mb-4 mb-lg-0">
                     <div class="card card-body justify-content-between bg-primary text-light">
                        ...
                        <p class="text-align-center text-white">
                           Jl. Guru Saleh RT06/RW10. Kel Bintaro, Kec Pesanggrahan
                           <br>Jakarta Selatan. DKI Jakarta. 12330
                        </p>
                        <b class="text-white">Search Maps : Jani Jack</b>
