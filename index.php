...
<html lang="en">
   <head>
      ...
      <meta property='og:image' content="https://duniavps.com/sendi/assets/img/foto-thumb.webp" />
      ...
      c212.5106,0,438.9999,3.5,584.4982,1.5844v139.9126H0V0z"/>
         ...
         <section id="pelaksanaan" class="spacer-one-top-lg">
            ...
            <div class="container spacer-one-bottom-lg">
               ...
               <!--Row-->
               <div class="row">
                  <div class="col-3 text-center mb-4 mb-lg-0">
                     <h2 id="d" class="display-4">0</h2>
                     <h4>Hari</h4>
                  </div>
                  <div class="col-3 text-center mb-4 mb-lg-0">
                     <h2 id="h" class="display-4">0</h2>
                     <h4>Jam</h4>
                  </div>
                  <div class="col-3 text-center mb-4 mb-lg-0">
                     <h2 id="m" class="display-4">0</h2>
                     <h4>Menit</h4>
                  </div>
                  <div class="col-3 text-center mb-4 mb-lg-0">
                     <h2 id="s" class="display-4">0</h2>
                     <h4>Detik</h4>
                  </div>
               </div>
                        ...
                        <div class="row mt-4">
                           <div class="col-md-6" data-aos="fade-right" data-aos-easing="ease-in-out" data-aos-duration="1000">
                              <div class="col-12 my-5">
                                 <div class="row d-flex align-items-center">
                                    <div class="col-3">
                                       <img src="assets/img/svg/masker.svg" class="col-12" alt="Icon">
                                    </div>
                                    <div class="col">Wajib menggunakan masker selama acara berlangsung</div>
                                 </div>
                              </div>
                              <div class="col-12 my-5">
                                 <div class="row d-flex align-items-center">
                                    <div class="col-3">
                                       <img src="assets/img/svg/virus.svg" class="col-11" alt="Icon">
                                    </div>
                                    <div class="col">Tidak memiliki riwayat berkontak dengan pasien COVID-19</div>
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="1000">
                              <div class="col-12 my-5">
                                 <div class="row d-flex align-items-center">
                                    <div class="col-3">
                                       <img src="assets/img/svg/jarak.svg" class="col-11" alt="Icon">
                                    </div>
                                    <div class="col">Saling menjaga jarak ketika menghadiri acara</div>
                                 </div>
                              </div>
                              <div class="col-12 my-5">
                                 <div class="row d-flex align-items-center">
                                    <div class="col-3">
                                       <img src="assets/img/svg/kerumun.svg" class="col-11" alt="Icon">
                                    </div>
                                    <div class="col">Dilarang berkerumun</div>
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="col-md-5" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="1000">
                     ...
                     <div class="row justify-content-center">
                        <div class="col">
                           ...
                           <h1 class="display-5">Ucapan dan Doa</h1>
                           </div>
                        </div>
                     </div>
                     <!--End row-->
                     <form method="post">
                        <div class="form-group">
                           <label >Nama</label>
                           <input name="name" type="text" class="form-control form-control-lg" placeholder="Nama Lengkap / Panggilan">
                        </div>
                        <div class="form-group">
                           <label>Pesan</label>
                        ...
                        <div class="form-group text-center">
                           <button class="btn btn-lg btn-block btn-primary" type="submit">Kirim</button>
